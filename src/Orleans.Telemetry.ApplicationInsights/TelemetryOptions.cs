...
{
    /// <summary>
    /// TelemetryOptions defines the custom behavior of the features to add
    /// </summary>
    public class TelemetryOptions
    {
        /// <summary>
        /// Gets or sets a value indicating whether the silo lifecycle events should be logged as custom events. Defaults to true.
        /// </summary>
